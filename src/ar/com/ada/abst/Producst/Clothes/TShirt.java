...
public class TShirt extends Clothes {
    ...
    public TShirt(String gender){
        this.gender = gender;
    }

    public TShirt(String gender, String brand){
        this.gender = gender;
        this.brand = brand;
    }

    public TShirt(String productName, Double price, String items, String gender, String brand){
