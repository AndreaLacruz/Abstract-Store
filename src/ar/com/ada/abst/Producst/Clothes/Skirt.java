...
public class Skirt extends Clothes {
    ...
    public Skirt(String gender){
        this.gender = gender;
    }

    public Skirt(String gender, String brand){
        this.gender = gender;
        this.brand = brand;
    }

    public Skirt(String productName, Double price, String items, String gender, String brand){
